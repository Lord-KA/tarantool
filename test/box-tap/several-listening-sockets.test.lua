...
errmsg = "Invalid URI table: expected {uri = string, params = table}, " ..
         "{string, params = table} or string, {uri, params = table}"
test_error_message(uri_table, errmsg)

-- Default params is banned for single URI
uri_table = {unix_sock_path, default_params = {q = "v"}}
errmsg = "Default URI query parameters are not allowed for single URI"
test_error_message(uri_table, errmsg)
...
-- URI query parameters should be passed in lua table
uri_table = {unix_sock_path, params = function()end}
errmsg = "Incorrect type for URI query parameters: should be a table"
test_error_message(uri_table, errmsg)

-- URI query parameter name should be a string
uri_table = {unix_sock_path, params = {"x"}}
errmsg = "Incorrect type for URI query parameter name: should be a string"
test_error_message(uri_table, errmsg)

-- URI query parameter should be one of types: string, number, table
uri_table = {unix_sock_path, params = {q = function()end}}
errmsg = "Incorrect type for URI query parameter: " ..
         "should be string, number or table"
test_error_message(uri_table, errmsg)

-- "URI query parameter value should be one of types: string, number
uri_table = {unix_sock_path, params = {q = {function()end}}}
errmsg = "Incorrect type for URI query parameter value: " ..
...
-- URI query parameters arenot allowed for multiple URIs
uri_table = {unix_sock_path, unix_sock_path, params = {q = "v"}}
errmsg = "URI query parameters are not allowed for multiple URIs"
test_error_message(uri_table, errmsg)

-- Test default URI query parameters
